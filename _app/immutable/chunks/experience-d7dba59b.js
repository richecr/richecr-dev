import{C as e}from"./types-1ebf2f37.js";import{A as t}from"./assets-6c62ae5a.js";import{g as n}from"./skills-380c8864.js";const r=[{slug:"software-engineer-3",company:"OLX Brasil",description:`
...
`,contract:e.FullTime,type:"Software Development",location:"Remote",period:{from:new Date(2026,8,1)},skills:n("kotlin","python","ts","nodejs","fastapi","spring","postgresql","redis","docker","kubernetes","aws","kafka","litellm","mcp","strands-agents","langchain","bedrock","agentcore-runtime"),name:"Software Engineer III",color:"blue",links:[],logo:t.OLX,shortDescription:"Negotiation team: High-throughput chat platform handling 90k req/min, resilience strategies, and LLM/Agentic systems."},{slug:"software-engineer-2",company:"OLX Brasil",description:`
