import{A as e}from"./assets-6ab95cda.js";function p(a,...i){const s=Object.assign({},a);return Object.keys(s).forEach(o=>{i.includes(o)&&delete s[o]}),s}const u=`# AWS
...
AWS revolutionizes how technology is used to solve business problems, offering a vast suite of cloud computing services that provide a host of infrastructure and software solutions for digital businesses.`,m=`# Clojure
...
CSS has evolved over the years and now supports graphics, animations, and interactions that were previously possible only with JavaScript. As web design continues to evolve, CSS remains a fundamental skill for web developers, providing the tools needed to design visually compelling and user-friendly websites.`,h=`# Docker
...
Docker enhances the development, testing, and deployment processes of applications by encapsulating them in lightweight, portable containers. This approach has widely been adopted for its efficiency and compatibility across multiple environments.`,f=`# FastAPI
...
FastAPI simplifies API development with its straightforward, rapid, and efficient approach, making it highly suitable for modern web applications that require complex data interactions and high-performance responsiveness.`,y=`# Fastify
...
Fastify stands out in the Node.js ecosystem for its focus on performance and scalability, making it a compelling choice for developers looking to build fast, efficient web applications.`,b=`# Go
...
Go has gained popularity for its ability to handle modern computing challenges such as cloud services and distributed systems efficiently. Its robustness, simplicity, and powerful standard libraries make it a favored choice for developers in high-performance computing environments.`,v=`# Java
...
Java is a robust, high-level programming language developed by Sun Microsystems, now maintained by Oracle, known for its portability, reliability, and extensive use in large-scale enterprise environments.`,w=`# JavaScript
...
JavaScript is a dynamic, essential web technology known for its role in enhancing user interaction and functionality in web applications, making it indispensable for modern web development.`,k=`# Kafka
...
Kafka's unique architecture allows it to be not merely a messaging system but a platform for handling all of the data's journey from ingestion through to processing and real-time querying capabilities, making it integral to modern data-driven applications.`,S=`# Kotlin
...
Kotlin is a versatile, modern programming language developed by JetBrains, acclaimed for its conciseness, safety features, and seamless interoperability with Java, making it a popular choice for both Android development and server-side applications.`,x=`# Kubernetes
...
AgentCore Runtime helps bridge the gap between an agent prototype and a dependable service that can be deployed, operated, and integrated into production systems.`,P=`# Amazon Bedrock
...
Amazon Bedrock gives teams a managed path to production generative AI while preserving the operational and security patterns of the AWS ecosystem.`,I=`# LangChain
...
LangChain provides a flexible foundation for developing and evolving LLM applications while keeping their model, data, and tool integrations organized.`,C=`# LiteLLM
...
LiteLLM simplifies the construction of resilient LLM applications by keeping provider details behind a stable interface and enabling operational controls around model calls.`,L=`# Model Context Protocol (MCP)
...
MCP provides a practical foundation for building agentic systems with modular integrations, clear capability boundaries, and reusable context providers.`,M=`# MongoDB
...
MongoDB has become a cornerstone for modern application development, particularly in microservices, big data, and real-time web apps, where flexibility and scalability are essential.`,T=`# NestJS
...
NestJS stands out in the Node.js ecosystem by bringing enterprise-grade patterns and productivity to backend development, making it a top choice for teams building modern APIs, microservices, and cloud-native applications.`,J=`# Nginx
...
Nginx is widely appreciated for its performance, stability, and low resource usage, making it an essential tool in hosting high-traffic websites, web applications, and for use as a reverse proxy and load balancer in complex application architectures.`,E=`# Nodejs
...
Node.js revolutionizes backend development by enabling JavaScript to perform server-side operations, providing a powerful platform for developing fast and scalable network applications.`,N=`# Numpy
...
NumPy is essential for any type of scientific or numerical computation in Python due to its efficiency and the foundational tools it provides for more complex operations. This makes it indispensable for data analysis, machine learning, and broader scientific computing tasks.`,R=`# Pandas
...
Python is a high-level, open-source programming language created by Guido van Rossum and maintained by an active global community.`,F=`# ReactJS
...
React revolutionizes the way developers build web applications, offering a scalable, powerful, and highly efficient approach to developing web interfaces.`,z=`# Redis
...
Redis excels in situations where high availability and high performance are critical, and it's often used for caching to reduce the load on traditional databases or to speed up response times. Its simplicity and the ability to scale horizontally make it a popular choice among developers for modern, high-performance applications.`,q=`# SapHana
...
spaCy is widely regarded as one of the go-to libraries for any NLP task in Python, from simple tokenization to complex entity recognition, making it a key tool in the arsenal of data scientists, linguists, and AI developers.`,O=`# Spring
...
Spring stands out in the enterprise Java community for its depth, providing extensive infrastructure support and enabling developers to create high-performing, robust applications efficiently.`,W=`# Strands Agents
...
Strands Agents helps teams turn LLM capabilities into structured, tool-using workflows that can be integrated with real application services.`,B=`# Svelte
...
TypeScript is a powerful enhancement to JavaScript, developed by Microsoft, that brings static typing and object-oriented tools to modern JavaScript development, making it a favorite among developers for building complex and large-scale applications.`,_=`# VueJS
...
Vue.js enhances the development of web applications with its approachable concept, combined with powerful capabilities for building scalable and fast-reacting user interfaces.`,t=a=>a,G=[t({name:"Programming Languages",slug:"pro-lang"}),t({name:"Frameworks",slug:"framework"}),t({name:"Libraries",slug:"library"}),t({name:"Langauges",slug:"lang"}),t({name:"Databases",slug:"db"}),t({name:"ORMs",slug:"orm"}),t({name:"DevOps",slug:"devops"}),t({name:"Testing",slug:"test"}),t({name:"Dev Tools",slug:"devtools"}),t({name:"Markup & Style",slug:"markup-style"}),t({name:"Design",slug:"design"}),t({name:"Soft Skills",slug:"soft"})],n=a=>{const i=p(a,"category");return a.category&&(i.category=G.find(s=>s.slug===a.category)),i},c=[n({slug:"python",color:"blue",description:D,logo:e.Python,name:"Python",category:"pro-lang"}),n({slug:"java",color:"orange",description:v,logo:e.Java,name:"Java",category:"pro-lang"}),n({slug:"kotlin",color:"pink",description:S,logo:e.Kotlin,name:"Kotlin",category:"pro-lang"}),n({slug:"js",color:"yellow",description:w,logo:e.JavaScript,name:"Javascript",category:"pro-lang"}),n({slug:"ts",color:"blue",description:K,logo:e.TypeScript,name:"Typescript",category:"pro-lang"}),n({slug:"go",color:"orange",description:b,logo:e.Go,name:"Go",category:"pro-lang"}),n({slug:"clojure",color:"orange",description:m,logo:e.Clojure,name:"Clojure",category:"pro-lang"}),n({slug:"nodejs",color:"yellow",description:E,logo:e.NodeJs,name:"NodeJs",category:"framework"}),n({slug:"spring",color:"cyan",description:O,logo:e.Spring,name:"Spring",category:"framework"}),n({slug:"nestjs",color:"cyan",description:T,logo:e.NestJs,name:"NestJs",category:"framework"}),n({slug:"fastapi",color:"cyan",description:f,logo:e.FastApi,name:"FastApi",category:"library"}),n({slug:"fastify",color:"cyan",description:y,logo:e.Fastify,name:"Fastify",category:"library"}),n({slug:"expressjs",color:"orange",description:"",logo:e.ExpressJs,name:"ExpressJs",category:"library"}),n({slug:"reactjs",color:"cyan",description:F,logo:e.ReactJs,name:"React Js",category:"library"}),n({slug:"vuejs",color:"cyan",description:_,logo:e.VueJs,name:"Vue Js",category:"framework"}),n({slug:"svelte",color:"cyan",description:B,logo:e.Svelte,name:"svelte",category:"library"}),n({slug:"aws",color:"orange",description:u,logo:e.AWS,name:"Aws",category:"devops"}),n({slug:"docker",color:"orange",description:h,logo:e.Docker,name:"Docker",category:"devops"}),n({slug:"kubernetes",color:"orange",description:x,logo:e.Kubernetes,name:"Kubernetes",category:"devops"}),n({slug:"nginx",color:"orange",description:J,logo:e.Nginx,name:"Nginx",category:"devops"}),n({slug:"kafka",color:"orange",description:k,logo:e.Kafka,name:"Kafka",category:"devtools"}),n({slug:"litellm",color:"blue",description:C,logo:e.LiteLLM,name:"LiteLLM",category:"library"}),n({slug:"mcp",color:"blue",description:L,logo:e.MCP,name:"Model Context Protocol",category:"devtools"}),n({slug:"strands-agents",color:"blue",description:W,logo:e.StrandsAgents,name:"Strands Agents",category:"library"}),n({slug:"langchain",color:"blue",description:I,logo:e.LangChain,name:"LangChain",category:"library"}),n({slug:"bedrock",color:"orange",description:P,logo:e.Bedrock,name:"AWS Bedrock",category:"devops"}),n({slug:"agentcore-runtime",color:"blue",description:A,logo:e.AgentCoreRuntime,name:"AgentCore Runtime",category:"library"}),n({slug:"postgresql",color:"orange",description:j,logo:e.PostgreSQL,name:"PostgreSQL",category:"db"}),n({slug:"mongodb",color:"orange",description:M,logo:e.MongoDB,name:"MongoDB",category:"db"}),n({slug:"redis",color:"orange",description:z,logo:e.Redis,name:"Redis",category:"db"}),n({slug:"saphana",color:"orange",description:q,logo:e.SapHana,name:"SapHana",category:"db"}),n({slug:"css",color:"orange",description:g,logo:e.CSS,name:"CSS",category:"markup-style"}),n({slug:"sklearn",color:"orange",description:H,logo:e.Sklearn,name:"Sklearn",category:"library"}),n({slug:"numpy",color:"orange",description:N,logo:e.Numpy,name:"Numpy",category:"library"}),n({slug:"pandas",color:"orange",description:R,logo:e.Pandas,name:"Pandas",category:"library"}),n({slug:"spacy",color:"orange",description:V,logo:e.Spacy,name:"Spacy",category:"library"})],U="Skills",X=(...a)=>c.filter(i=>a.includes(i.slug)),$=a=>{const i=[],s=[];return c.forEach(o=>{if(a.trim()&&!o.name.toLowerCase().includes(a.trim().toLowerCase()))return;if(!o.category){console.log(o.category),s.push(o);return}let r=i.find(d=>{var l;return d.category.slug===((l=o.category)==null?void 0:l.slug)});r||(r={items:[],category:o.category},i.push(r)),r.items.push(o)}),s.length!==0&&i.push({category:{name:"Others",slug:"others"},items:s}),i};export{$ as a,X as g,c as i,U as t};
