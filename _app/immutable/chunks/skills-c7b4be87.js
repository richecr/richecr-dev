import{A as e}from"./index-8bd290b4.js";const p=`# Svelte
...
Go has gained popularity for its ability to handle modern computing challenges such as cloud services and distributed systems efficiently. Its robustness, simplicity, and powerful standard libraries make it a favored choice for developers in high-performance computing environments.`,b=`# Clojure
...
Node.js revolutionizes backend development by enabling JavaScript to perform server-side operations, providing a powerful platform for developing fast and scalable network applications.`,w=`# FastAPI
...
FastAPI simplifies API development with its straightforward, rapid, and efficient approach, making it highly suitable for modern web applications that require complex data interactions and high-performance responsiveness.`,k=`# Spring
...
Spring stands out in the enterprise Java community for its depth, providing extensive infrastructure support and enabling developers to create high-performing, robust applications efficiently.`,S=`# Fastify
...
Fastify stands out in the Node.js ecosystem for its focus on performance and scalability, making it a compelling choice for developers looking to build fast, efficient web applications.`,x=`# ReactJS
...
React revolutionizes the way developers build web applications, offering a scalable, powerful, and highly efficient approach to developing web interfaces.`,P=`# VueJS
...
Vue.js enhances the development of web applications with its approachable concept, combined with powerful capabilities for building scalable and fast-reacting user interfaces.`,A=`# AWS
...
AWS revolutionizes how technology is used to solve business problems, offering a vast suite of cloud computing services that provide a host of infrastructure and software solutions for digital businesses.`,I=`# Docker
...
Docker enhances the development, testing, and deployment processes of applications by encapsulating them in lightweight, portable containers. This approach has widely been adopted for its efficiency and compatibility across multiple environments.`,C=`# Kubernetes
...
Nginx is widely appreciated for its performance, stability, and low resource usage, making it an essential tool in hosting high-traffic websites, web applications, and for use as a reverse proxy and load balancer in complex application architectures.`,J=`# Kafka
...
Kafka's unique architecture allows it to be not merely a messaging system but a platform for handling all of the data's journey from ingestion through to processing and real-time querying capabilities, making it integral to modern data-driven applications.`,E=`# Postgresql
...
Redis excels in situations where high availability and high performance are critical, and it's often used for caching to reduce the load on traditional databases or to speed up response times. Its simplicity and the ability to scale horizontally make it a popular choice among developers for modern, high-performance applications.`,N=`# CSS
...
CSS has evolved over the years and now supports graphics, animations, and interactions that were previously possible only with JavaScript. As web design continues to evolve, CSS remains a fundamental skill for web developers, providing the tools needed to design visually compelling and user-friendly websites.`,j=`# SapHana
...
NumPy is essential for any type of scientific or numerical computation in Python due to its efficiency and the foundational tools it provides for more complex operations. This makes it indispensable for data analysis, machine learning, and broader scientific computing tasks.`,M=`# Pandas
...
spaCy is widely regarded as one of the go-to libraries for any NLP task in Python, from simple tokenization to complex entity recognition, making it a key tool in the arsenal of data scientists, linguists, and AI developers.`;function H(a,...i){const s=Object.assign({},a);return Object.keys(s).forEach(o=>{i.includes(o)&&delete s[o]}),s}const t=a=>a,z=[t({name:"Programming Languages",slug:"pro-lang"}),t({name:"Frameworks",slug:"framework"}),t({name:"Libraries",slug:"library"}),t({name:"Langauges",slug:"lang"}),t({name:"Databases",slug:"db"}),t({name:"ORMs",slug:"orm"}),t({name:"DevOps",slug:"devops"}),t({name:"Testing",slug:"test"}),t({name:"Dev Tools",slug:"devtools"}),t({name:"Markup & Style",slug:"markup-style"}),t({name:"Design",slug:"design"}),t({name:"Soft Skills",slug:"soft"})],n=a=>{const i=H(a,"category");return a.category&&(i.category=z.find(s=>s.slug===a.category)),i},c=[n({slug:"python",color:"blue",description:u,logo:e.Python,name:"Python",category:"pro-lang"}),n({slug:"java",color:"orange",description:m,logo:e.Java,name:"Java",category:"pro-lang"}),n({slug:"kotlin",color:"pink",description:g,logo:e.Kotlin,name:"Kotlin",category:"pro-lang"}),n({slug:"js",color:"yellow",description:h,logo:e.JavaScript,name:"Javascript",category:"pro-lang"}),n({slug:"ts",color:"blue",description:f,logo:e.TypeScript,name:"Typescript",category:"pro-lang"}),n({slug:"go",color:"orange",description:y,logo:e.Go,name:"Go",category:"pro-lang"}),n({slug:"clojure",color:"orange",description:b,logo:e.Clojure,name:"Clojure",category:"pro-lang"}),n({slug:"nodejs",color:"yellow",description:v,logo:e.NodeJs,name:"NodeJs",category:"framework"}),n({slug:"spring",color:"cyan",description:k,logo:e.Spring,name:"Spring",category:"framework"}),n({slug:"fastapi",color:"cyan",description:w,logo:e.FastApi,name:"FastApi",category:"library"}),n({slug:"fastify",color:"cyan",description:S,logo:e.Fastify,name:"Fastify",category:"library"}),n({slug:"expressjs",color:"orange",description:"",logo:e.ExpressJs,name:"ExpressJs",category:"library"}),n({slug:"reactjs",color:"cyan",description:x,logo:e.ReactJs,name:"React Js",category:"library"}),n({slug:"vuejs",color:"cyan",description:P,logo:e.VueJs,name:"Vue Js",category:"framework"}),n({slug:"svelte",color:"cyan",description:p,logo:e.Svelte,name:"svelte",category:"library"}),n({slug:"aws",color:"orange",description:A,logo:e.AWS,name:"Aws",category:"devops"}),n({slug:"docker",color:"orange",description:I,logo:e.Docker,name:"Docker",category:"devops"}),n({slug:"kubernetes",color:"orange",description:C,logo:e.Kubernetes,name:"Kubernetes",category:"devops"}),n({slug:"nginx",color:"orange",description:T,logo:e.Nginx,name:"Nginx",category:"devops"}),n({slug:"kafka",color:"orange",description:J,logo:e.Kafka,name:"Kafka",category:"devtools"}),n({slug:"postgresql",color:"orange",description:E,logo:e.PostgreSQL,name:"PostgreSQL",category:"db"}),n({slug:"redis",color:"orange",description:R,logo:e.Redis,name:"Redis",category:"db"}),n({slug:"saphana",color:"orange",description:j,logo:e.SapHana,name:"SapHana",category:"db"}),n({slug:"css",color:"orange",description:N,logo:e.CSS,name:"CSS",category:"markup-style"}),n({slug:"sklearn",color:"orange",description:D,logo:e.Sklearn,name:"Sklearn",category:"library"}),n({slug:"numpy",color:"orange",description:L,logo:e.Numpy,name:"Numpy",category:"library"}),n({slug:"pandas",color:"orange",description:M,logo:e.Pandas,name:"Pandas",category:"library"}),n({slug:"spacy",color:"orange",description:F,logo:e.Spacy,name:"Spacy",category:"library"})],q="Skills",K=(...a)=>c.filter(i=>a.includes(i.slug)),W=a=>{const i=[],s=[];return c.forEach(o=>{if(a.trim()&&!o.name.toLowerCase().includes(a.trim().toLowerCase()))return;if(!o.category){console.log(o.category),s.push(o);return}let r=i.find(d=>{var l;return d.category.slug===((l=o.category)==null?void 0:l.slug)});r||(r={items:[],category:o.category},i.push(r)),r.items.push(o)}),s.length!==0&&i.push({category:{name:"Others",slug:"others"},items:s}),i};export{W as a,K as g,c as i,q as t};
