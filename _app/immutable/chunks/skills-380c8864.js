import{A as e}from"./assets-6c62ae5a.js";function p(a,...i){const s=Object.assign({},a);return Object.keys(s).forEach(o=>{i.includes(o)&&delete s[o]}),s}const u=`# AWS
...
LiteLLM simplifies the construction of resilient LLM applications by keeping provider details behind a stable interface and enabling operational controls around model calls.`,T=`# Model Context Protocol (MCP)
...
MongoDB has become a cornerstone for modern application development, particularly in microservices, big data, and real-time web apps, where flexibility and scalability are essential.`,L=`# NestJS
...
Strands Agents helps teams turn LLM capabilities into structured, tool-using workflows that can be integrated with real application services.`,K=`# Svelte
...
Vue.js enhances the development of web applications with its approachable concept, combined with powerful capabilities for building scalable and fast-reacting user interfaces.`,t=a=>a,G=[t({name:"Programming Languages",slug:"pro-lang"}),t({name:"Frameworks",slug:"framework"}),t({name:"Libraries",slug:"library"}),t({name:"Langauges",slug:"lang"}),t({name:"Databases",slug:"db"}),t({name:"ORMs",slug:"orm"}),t({name:"DevOps",slug:"devops"}),t({name:"Testing",slug:"test"}),t({name:"Dev Tools",slug:"devtools"}),t({name:"Markup & Style",slug:"markup-style"}),t({name:"Design",slug:"design"}),t({name:"Soft Skills",slug:"soft"})],n=a=>{const i=p(a,"category");return a.category&&(i.category=G.find(s=>s.slug===a.category)),i},c=[n({slug:"python",color:"blue",description:D,logo:e.Python,name:"Python",category:"pro-lang"}),n({slug:"java",color:"orange",description:v,logo:e.Java,name:"Java",category:"pro-lang"}),n({slug:"kotlin",color:"pink",description:S,logo:e.Kotlin,name:"Kotlin",category:"pro-lang"}),n({slug:"js",color:"yellow",description:w,logo:e.JavaScript,name:"Javascript",category:"pro-lang"}),n({slug:"ts",color:"blue",description:B,logo:e.TypeScript,name:"Typescript",category:"pro-lang"}),n({slug:"go",color:"orange",description:b,logo:e.Go,name:"Go",category:"pro-lang"}),n({slug:"clojure",color:"orange",description:m,logo:e.Clojure,name:"Clojure",category:"pro-lang"}),n({slug:"nodejs",color:"yellow",description:E,logo:e.NodeJs,name:"NodeJs",category:"framework"}),n({slug:"spring",color:"cyan",description:O,logo:e.Spring,name:"Spring",category:"framework"}),n({slug:"nestjs",color:"cyan",description:L,logo:e.NestJs,name:"NestJs",category:"framework"}),n({slug:"fastapi",color:"cyan",description:f,logo:e.FastApi,name:"FastApi",category:"library"}),n({slug:"fastify",color:"cyan",description:y,logo:e.Fastify,name:"Fastify",category:"library"}),n({slug:"expressjs",color:"orange",description:"",logo:e.ExpressJs,name:"ExpressJs",category:"library"}),n({slug:"reactjs",color:"cyan",description:F,logo:e.ReactJs,name:"React Js",category:"library"}),n({slug:"vuejs",color:"cyan",description:_,logo:e.VueJs,name:"Vue Js",category:"framework"}),n({slug:"svelte",color:"cyan",description:K,logo:e.Svelte,name:"svelte",category:"library"}),n({slug:"aws",color:"orange",description:u,logo:e.AWS,name:"Aws",category:"devops"}),n({slug:"docker",color:"orange",description:h,logo:e.Docker,name:"Docker",category:"devops"}),n({slug:"kubernetes",color:"orange",description:x,logo:e.Kubernetes,name:"Kubernetes",category:"devops"}),n({slug:"nginx",color:"orange",description:J,logo:e.Nginx,name:"Nginx",category:"devops"}),n({slug:"kafka",color:"orange",description:k,logo:e.Kafka,name:"Kafka",category:"devtools"}),n({slug:"litellm",color:"blue",description:C,logo:e.Unknown,name:"LiteLLM",category:"library"}),n({slug:"mcp",color:"blue",description:T,logo:e.Unknown,name:"Model Context Protocol",category:"devtools"}),n({slug:"strands-agents",color:"blue",description:W,logo:e.Unknown,name:"Strands Agents",category:"library"}),n({slug:"langchain",color:"blue",description:I,logo:e.Unknown,name:"LangChain",category:"library"}),n({slug:"bedrock",color:"orange",description:P,logo:e.Unknown,name:"AWS Bedrock",category:"devops"}),n({slug:"agentcore-runtime",color:"blue",description:A,logo:e.Unknown,name:"AgentCore Runtime",category:"library"}),n({slug:"postgresql",color:"orange",description:j,logo:e.PostgreSQL,name:"PostgreSQL",category:"db"}),n({slug:"mongodb",color:"orange",description:M,logo:e.MongoDB,name:"MongoDB",category:"db"}),n({slug:"redis",color:"orange",description:z,logo:e.Redis,name:"Redis",category:"db"}),n({slug:"saphana",color:"orange",description:q,logo:e.SapHana,name:"SapHana",category:"db"}),n({slug:"css",color:"orange",description:g,logo:e.CSS,name:"CSS",category:"markup-style"}),n({slug:"sklearn",color:"orange",description:H,logo:e.Sklearn,name:"Sklearn",category:"library"}),n({slug:"numpy",color:"orange",description:N,logo:e.Numpy,name:"Numpy",category:"library"}),n({slug:"pandas",color:"orange",description:R,logo:e.Pandas,name:"Pandas",category:"library"}),n({slug:"spacy",color:"orange",description:V,logo:e.Spacy,name:"Spacy",category:"library"})],Q="Skills",X=(...a)=>c.filter(i=>a.includes(i.slug)),$=a=>{const i=[],s=[];return c.forEach(o=>{if(a.trim()&&!o.name.toLowerCase().includes(a.trim().toLowerCase()))return;if(!o.category){console.log(o.category),s.push(o);return}let r=i.find(d=>{var l;return d.category.slug===((l=o.category)==null?void 0:l.slug)});r||(r={items:[],category:o.category},i.push(r)),r.items.push(o)}),s.length!==0&&i.push({category:{name:"Others",slug:"others"},items:s}),i};export{$ as a,X as g,c as i,Q as t};
