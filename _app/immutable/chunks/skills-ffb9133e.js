...
MongoDB has become a cornerstone for modern application development, particularly in microservices, big data, and real-time web apps, where flexibility and scalability are essential.`,A=`# NestJS
...
NestJS stands out in the Node.js ecosystem by bringing enterprise-grade patterns and productivity to backend development, making it a top choice for teams building modern APIs, microservices, and cloud-native applications.`,I=`# Nginx
...
Nginx is widely appreciated for its performance, stability, and low resource usage, making it an essential tool in hosting high-traffic websites, web applications, and for use as a reverse proxy and load balancer in complex application architectures.`,C=`# Nodejs
...
Node.js revolutionizes backend development by enabling JavaScript to perform server-side operations, providing a powerful platform for developing fast and scalable network applications.`,T=`# Numpy
...
NumPy is essential for any type of scientific or numerical computation in Python due to its efficiency and the foundational tools it provides for more complex operations. This makes it indispensable for data analysis, machine learning, and broader scientific computing tasks.`,J=`# Pandas
...
Python is a high-level, open-source programming language created by Guido van Rossum and maintained by an active global community.`,E=`# ReactJS
...
React revolutionizes the way developers build web applications, offering a scalable, powerful, and highly efficient approach to developing web interfaces.`,j=`# Redis
...
Redis excels in situations where high availability and high performance are critical, and it's often used for caching to reduce the load on traditional databases or to speed up response times. Its simplicity and the ability to scale horizontally make it a popular choice among developers for modern, high-performance applications.`,M=`# SapHana
...
spaCy is widely regarded as one of the go-to libraries for any NLP task in Python, from simple tokenization to complex entity recognition, making it a key tool in the arsenal of data scientists, linguists, and AI developers.`,L=`# Spring
...
Spring stands out in the enterprise Java community for its depth, providing extensive infrastructure support and enabling developers to create high-performing, robust applications efficiently.`,H=`# Svelte
...
TypeScript is a powerful enhancement to JavaScript, developed by Microsoft, that brings static typing and object-oriented tools to modern JavaScript development, making it a favorite among developers for building complex and large-scale applications.`,z=`# VueJS
...
Vue.js enhances the development of web applications with its approachable concept, combined with powerful capabilities for building scalable and fast-reacting user interfaces.`,t=a=>a,V=[t({name:"Programming Languages",slug:"pro-lang"}),t({name:"Frameworks",slug:"framework"}),t({name:"Libraries",slug:"library"}),t({name:"Langauges",slug:"lang"}),t({name:"Databases",slug:"db"}),t({name:"ORMs",slug:"orm"}),t({name:"DevOps",slug:"devops"}),t({name:"Testing",slug:"test"}),t({name:"Dev Tools",slug:"devtools"}),t({name:"Markup & Style",slug:"markup-style"}),t({name:"Design",slug:"design"}),t({name:"Soft Skills",slug:"soft"})],n=a=>{const i=p(a,"category");return a.category&&(i.category=V.find(s=>s.slug===a.category)),i},c=[n({slug:"python",color:"blue",description:R,logo:e.Python,name:"Python",category:"pro-lang"}),n({slug:"java",color:"orange",description:v,logo:e.Java,name:"Java",category:"pro-lang"}),n({slug:"kotlin",color:"pink",description:S,logo:e.Kotlin,name:"Kotlin",category:"pro-lang"}),n({slug:"js",color:"yellow",description:w,logo:e.JavaScript,name:"Javascript",category:"pro-lang"}),n({slug:"ts",color:"blue",description:q,logo:e.TypeScript,name:"Typescript",category:"pro-lang"}),n({slug:"go",color:"orange",description:b,logo:e.Go,name:"Go",category:"pro-lang"}),n({slug:"clojure",color:"orange",description:m,logo:e.Clojure,name:"Clojure",category:"pro-lang"}),n({slug:"nodejs",color:"yellow",description:C,logo:e.NodeJs,name:"NodeJs",category:"framework"}),n({slug:"spring",color:"cyan",description:L,logo:e.Spring,name:"Spring",category:"framework"}),n({slug:"nestjs",color:"cyan",description:A,logo:e.NestJs,name:"NestJs",category:"framework"}),n({slug:"fastapi",color:"cyan",description:f,logo:e.FastApi,name:"FastApi",category:"library"}),n({slug:"fastify",color:"cyan",description:y,logo:e.Fastify,name:"Fastify",category:"library"}),n({slug:"expressjs",color:"orange",description:"",logo:e.ExpressJs,name:"ExpressJs",category:"library"}),n({slug:"reactjs",color:"cyan",description:E,logo:e.ReactJs,name:"React Js",category:"library"}),n({slug:"vuejs",color:"cyan",description:z,logo:e.VueJs,name:"Vue Js",category:"framework"}),n({slug:"svelte",color:"cyan",description:H,logo:e.Svelte,name:"svelte",category:"library"}),n({slug:"aws",color:"orange",description:u,logo:e.AWS,name:"Aws",category:"devops"}),n({slug:"docker",color:"orange",description:h,logo:e.Docker,name:"Docker",category:"devops"}),n({slug:"kubernetes",color:"orange",description:x,logo:e.Kubernetes,name:"Kubernetes",category:"devops"}),n({slug:"nginx",color:"orange",description:I,logo:e.Nginx,name:"Nginx",category:"devops"}),n({slug:"kafka",color:"orange",description:k,logo:e.Kafka,name:"Kafka",category:"devtools"}),n({slug:"postgresql",color:"orange",description:N,logo:e.PostgreSQL,name:"PostgreSQL",category:"db"}),n({slug:"mongodb",color:"orange",description:P,logo:e.MongoDB,name:"MongoDB",category:"db"}),n({slug:"redis",color:"orange",description:j,logo:e.Redis,name:"Redis",category:"db"}),n({slug:"saphana",color:"orange",description:M,logo:e.SapHana,name:"SapHana",category:"db"}),n({slug:"css",color:"orange",description:g,logo:e.CSS,name:"CSS",category:"markup-style"}),n({slug:"sklearn",color:"orange",description:D,logo:e.Sklearn,name:"Sklearn",category:"library"}),n({slug:"numpy",color:"orange",description:T,logo:e.Numpy,name:"Numpy",category:"library"}),n({slug:"pandas",color:"orange",description:J,logo:e.Pandas,name:"Pandas",category:"library"}),n({slug:"spacy",color:"orange",description:F,logo:e.Spacy,name:"Spacy",category:"library"})],K="Skills",W=(...a)=>c.filter(i=>a.includes(i.slug)),G=a=>{const i=[],s=[];return c.forEach(o=>{if(a.trim()&&!o.name.toLowerCase().includes(a.trim().toLowerCase()))return;if(!o.category){console.log(o.category),s.push(o);return}let r=i.find(d=>{var l;return d.category.slug===((l=o.category)==null?void 0:l.slug)});r||(r={items:[],category:o.category},i.push(r)),r.items.push(o)}),s.length!==0&&i.push({category:{name:"Others",slug:"others"},items:s}),i};export{G as a,W as g,c as i,K as t};
