...
const Assets = {
	...
	LSI: a('lsi.jpeg'),
	UFCG: a('ufcg.jpeg'),
	FullCycle: a('fullcycle.jpeg'),
	PyElit: a('pyelit.png'),
	BarbeariaSaraiva: a('barbearia-saraiva.png'),
	QuemGastaMais: a('quem-gasta-mais.png'),
	AWS: a('aws.svg'),
	...
	TypeScript: a('ts.png'),
	Clojure: a('clojure.png'),
	SapHana: a('saphana.jpeg'),
	VueJs: a('vue.png'),
	ReactJs: a('react.svg'),
	Dart: a('dart.png'),
	Kotlin: a('kotlin.png'),
	...
	NestJs: a('nest.svg'),
	LiteLLM: a('litellm.svg'),
	MCP: a('mcp.svg'),
	StrandsAgents: a('strands-agents.svg'),
	LangChain: a('langchain.svg'),
	Bedrock: a('bedrock.svg'),
	AgentCoreRuntime: a('agentcore-runtime.svg'),
	Quasar: a('quasar.svg'),
	SolidJs: a('solid.svg'),
